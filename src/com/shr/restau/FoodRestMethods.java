...
public class FoodRestMethods {
	...
	public static void main(String[] args) {
		Menu menu = new Menu();
		menu.addMenuItem(new MenuItemDetails(ItemType.APPETIZERS, "samosa", 2.0));
		menu.addMenuItem(new MenuItemDetails(ItemType.APPETIZERS, "panipuri", 3.0));
		menu.printMenuItems();
		menu.updateMenuItems(new MenuItemDetails(ItemType.APPETIZERS, "panipuri", 4.0));
		menu.printMenuItems();
		menu.deleteMenuItems(new MenuItemDetails(ItemType.APPETIZERS, "panipuri", 4.0));
		menu.printMenuItems();
	}
...
//	public Message addFoodItem(MenuItemDetails m) {
//		Menu menu = new Menu();
